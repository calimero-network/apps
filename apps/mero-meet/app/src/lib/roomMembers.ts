...
/**
 * The two fields this module actually reads.
 *
 * Structural rather than importing a named contract type: mero-meet's roster
 * rows are `Presence` (memberId, username, plus call state) and mero-stream's
 * are `Member`. Both satisfy this, and neither has to be converted to feed a
 * label.
 */
