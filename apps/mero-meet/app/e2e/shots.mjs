#!/usr/bin/env node
/**
 * app/e2e/shots.mjs — real screenshots of the team/room UI, with no node.
 *
...
const SCENARIOS = [
  ["teams", "Your teams", '[data-testid="team-row"]'],
  ["teams-empty", "No teams yet", '[data-testid="open-join"]'],
  [
    "teams-not-installed",
    "Not installed on this node",
    '[data-testid="open-join"]',
  ],
  ["rooms", "Rooms inside one team", '[data-testid="room-row"]'],
  ["invite", "An invitation", '[data-testid="invite-modal"]'],
  ["dark", "Dark theme", '[data-testid="room-row"]'],
];
