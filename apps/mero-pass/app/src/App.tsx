  ...
  return (
    <>
      {/* ⚠️ APP LEVEL, not inside a route. An invitation link can land on any
          path — `/` from a share, `/home` from the launcher appending
          `?invitation=…`, `/vault/:id` from a forwarded URL — and a prompt
          mounted on one page is a prompt that misses on every other one. It
      ...
      <Routes>
        ...
        {/* A space is a namespace: the people, and the vaults they share. */}
