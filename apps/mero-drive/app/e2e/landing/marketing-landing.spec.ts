/**
 * Landing page contract for Mero Drive Docs.
 *
...
test.describe('Mero Drive Docs landing page', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
  });

  test('hero names the app and its tagline', async ({ page }) => {
    await expect(page.getByRole('heading', { level: 1, name: "Mero Drive Docs" })).toBeVisible();
