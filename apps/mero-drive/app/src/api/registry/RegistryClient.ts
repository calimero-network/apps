 ...
 *
 * NOTE: hand-edited 2026-04-28 to drop registry-side `Visibility`. Subgroup
 * visibility now lives in Calimero core (`GroupInfo.subgroup_visibility`,
 * `setSubgroupVisibility`) per core PR #2261. The earlier 2026-04-24
 * `alias` hand-edit is preserved.
 *
