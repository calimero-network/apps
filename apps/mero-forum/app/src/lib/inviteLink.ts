...
//
//   https://links.calimero.network/com.calimero.mero-forum/join?invitation=<code>
//
...
//
//   1. **It pointed wherever the Invite button happened to be.** A forum invite
 ...
 */
export const APP_SLUG = "com.calimero.mero-forum";
 ...
 * slug like `com.calimero.mero-forum`.
 *
