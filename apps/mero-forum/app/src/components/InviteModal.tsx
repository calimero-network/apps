 ...
 *
 * This replaces an inline panel that expanded in place below the space list.
 ...
 *     invitation for one space look current while you were reading another;
...
export default function InviteModal({
  ...
  open: boolean;
  code: string;
  /** What the invitation grants — "Whole space · Foo" or "Opens Bar". */
  scope: string;
  hint?: ReactNode;
  onClose: () => void;
}) {
