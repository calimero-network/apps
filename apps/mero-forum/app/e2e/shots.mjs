...
const SCENARIOS = [
  ["spaces", "Your spaces", '[data-testid="space-row"]'],
  ["forums", "Forums inside one space", '[data-testid="forum-row"]'],
  ["feed", "A forum, posting as yourself", '[data-testid="nickname-bar"]'],
  ["feed-unnamed", "No name picked yet", '[data-testid="nickname-bar"]'],
  [
    "post",
    "A thread, with comment votes and moderation",
    '[data-testid="comment"]',
  ],
