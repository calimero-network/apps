/**
 * Landing page contract for Mero Chess — all three pages of it.
 *
...
test.describe('Mero Chess landing page', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
  });

  test('hero names the app and its tagline', async ({ page }) => {
    await expect(page.getByRole('heading', { level: 1, name: "Mero Chess" })).toBeVisible();
