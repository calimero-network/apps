...
} as unknown as ChessInvitationPayload["invitation"];

const PAYLOAD: ChessInvitationPayload = {
...
describe("the link builders", () => {
  it("build on the package id, because the launcher matches Application.package", () => {
    ...
    expect(APP_SLUG).toBe("com.calimero.mero-chess");
