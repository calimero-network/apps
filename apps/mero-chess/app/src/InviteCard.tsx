...
/**
 * Mint a shareable invitation to this table.
 *
...
export function InviteCard({ contextId }: { contextId: string }) {
  ...
  // in — and `ContextPicker` creates tables directly in the namespace, so that
  ...
  return (
    <div className="card">
      ...
      <p className="empty" style={{ marginBottom: 14 }}>
        ...
        machine that has it. Whoever opens it joins this table — they can take
        the free seat, or watch.
      </p>
