...
createRoot(root).render(
  <Wrapper>
    {/*
      ...
      `packageName` is NOT optional in practice for a hosted deployment, and
      `registryUrl` travels with it — mero-react has no default registry, so a
      package name sent without one reaches the auth frontend with nothing to
      resolve it against.
