...
export default async function globalSetup() {
  ...
  if (!existsSync(MPK_PATH)) {
    throw new Error(`mero-sheets .mpk not found at ${MPK_PATH}. In CI it arrives as the mpk-mero-sheets artifact via KV_MPK_PATH; locally run: cd logic && ./build-bundle.sh`);
  }
