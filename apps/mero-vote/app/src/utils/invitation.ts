...
/**
 * Shareable invitations and deep links for mero-vote.
 *
 ...
 */
export const APP_SLUG = "com.calimero.mero-vote";

/** What a mero-vote invitation actually carries. */
 ...
 * `https://links.calimero.network/com.calimero.mero-vote/join?invitation=…`
 *
