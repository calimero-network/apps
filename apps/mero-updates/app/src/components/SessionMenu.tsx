 ...
 * person on one machine, and it is why opening Mero Updates on an origin another
...
export default function SessionMenu() {
  ...
  // The active audience is OUR state, not the SDK's — `logout()` clears tokens and
  ...
  // /a whenever a context id is stored, and RequireAudience only checks that
