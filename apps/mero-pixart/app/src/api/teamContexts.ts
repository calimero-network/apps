...
//
// Team settings has no context in scope — it is a namespace screen — but
// document access lives in each document's contract. So a governance change that
// has to reach the document (Admin implies edit, and therefore demotion must
