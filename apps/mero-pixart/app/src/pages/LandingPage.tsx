      ...
      <section className={styles.heroSection}>
        <header className={styles.header}>
          ...
          <nav className={styles.headerNav}>
            ...
            <a href="https://github.com/calimero-network/apps/tree/main/apps/mero-pixart" target="_blank" rel="noopener noreferrer" className={styles.navLink}>GitHub</a>
          </nav>
          ...
          {menuOpen && (
            <div className={styles.mobileMenu}>
              ...
              <a href="https://github.com/calimero-network/apps/tree/main/apps/mero-pixart" target="_blank" rel="noopener noreferrer" className={styles.mobileMenuItem} onClick={closeMenu}>GitHub</a>
        ...
        <main className={styles.hero}>
          ...
          <div className={styles.heroActions}>
            ...
            <a
              ...
              href="https://github.com/calimero-network/apps/tree/main/apps/mero-pixart"
              target="_blank"
        ...
        <div className={styles.footerTop}>
          ...
          <div className={styles.footerLinks}>
            ...
            <div className={styles.footerCol}>
              ...
              <a href="https://github.com/calimero-network/apps/tree/main/apps/mero-pixart" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>GitHub org</a>
            </div>
            <div className={styles.footerCol}>
