/**
 * Landing page contract for Mero CRM — all three pages of it.
 *
...
test.describe('Mero CRM landing page', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/');
  });

  test('hero names the app and its tagline', async ({ page }) => {
    await expect(page.getByRole('heading', { level: 1, name: "Mero CRM" })).toBeVisible();
