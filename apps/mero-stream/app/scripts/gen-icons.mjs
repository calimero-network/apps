// Generates Mero Stream's icon set into app/public/ with zero dependencies:
//   favicon.ico (16/32/48 PNG-compressed entries), apple-touch-icon.png,
//   icon-192.png, icon-512.png.
// The mark — a play triangle broadcasting two arcs — is kept in sync by hand
...
// ---- art -------------------------------------------------------------------
// Play + broadcast arcs, in --accent-grad (#6d83ff → #a06bff). Deliberately a
// different silhouette from Mero Meet, which shares this palette: the two sit
// next to each other in the launcher and must not be told apart by colour alone.

const BG = "#090b10";

function mark(c, fit) {
  draw(c, poly([[9, 17], [9, 47], [32, 32]]), grad(9, 17, 32, 47, "#6d83ff", "#a06bff"), fit);
  draw(c, arc(7, 32, 32.5, 5, 0.45), solid("#a06bff"), fit);
  draw(c, arc(7, 32, 43.5, 5, 0.45), solid("#a06bff", 0.7), fit);
}
