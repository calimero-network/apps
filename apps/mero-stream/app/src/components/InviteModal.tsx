 ...
 *
 * This replaces an inline panel that expanded in place below the stream list.
 ...
 *     invitation for one stream look current while you were reading another;
...
export default function InviteModal({
  ...
  open: boolean;
  code: string;
  /** What the invitation grants — "Whole stream · Foo" or "Opens Bar". */
  scope: string;
  hint?: ReactNode;
  onClose: () => void;
}) {
